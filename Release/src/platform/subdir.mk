...
src/platform/%.o: ../src/platform/%.cpp
	...
	/usr/local/cuda-8.0/bin/nvcc -I/usr/local/include -I../src/OSA_CAP/inc -I../inc/ -I../src/ptz/inc -I../src/DxTimer/include -I../src/port -I../src/comm -I../src/platform -I../src/IPC -I/usr/local/include/libusb-1.0 -I../src/803 -O3 -ccbin aarch64-linux-gnu-g++ -gencode arch=compute_53,code=sm_53 -m64 -odir "src/platform" -M -o "$(@:%.o=%.d)" "$<"
